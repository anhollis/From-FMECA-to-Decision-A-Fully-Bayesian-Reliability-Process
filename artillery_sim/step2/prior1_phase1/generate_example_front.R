...
load('~/my_programs/artillery_sim/step2/prior1_phase1/posterior_samples')
library(MCMCpack)
library(lhs)
prior_samples=post_prior1_phase1[,c(1:25,36)]
...
save(start,file='~/my_programs/artillery_sim/step2/prior1_phase1/start')
...
for(i in 1:length(weight_levels)){
  ga_allR(prior_samples,sys_names,sys_names[25:26],random_start,start_cw, 
          ...
          nOut = 100, nDen=512,
          directory='~/my_programs/artillery_sim//step2/prior1_phase1/GA_res/')
}
